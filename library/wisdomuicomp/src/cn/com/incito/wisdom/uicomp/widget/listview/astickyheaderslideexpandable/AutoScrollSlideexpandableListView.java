 ...
 */
public class AutoScrollSlideexpandableListView extends ListView {
    ...
    public AutoScrollSlideexpandableListView(Context context) {
        super(context);
    }

    public AutoScrollSlideexpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoScrollSlideexpandableListView(Context context, AttributeSet attrs, int defStyle) {
