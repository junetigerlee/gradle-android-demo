package cn.com.incito.wisdom.uicomp.widget.radiogroup;
...
public class CustomerRadioGroup extends LinearLayout {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (mOnCheckedChangeListener != null) {
                        mOnCheckedChangeListener.onCheckedChanged(
                                CustomerRadioGroup.this, child.getId());
                    }
                    return true;
                }
            });
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(CustomerRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(CustomerRadioGroup.class.getName());
    }
