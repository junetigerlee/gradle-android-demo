...
import cn.com.incito.wisdom.uicomp.widget.listview.astickyheaderslideexpandable.PinnedSectionSlideexpandableListView;

/**
 * 带分组粘性章节同时可以折叠的可刷新的listview
 * 
 * @author qiujiaheng
 * 
 *         2014年3月22日
 */
public class RefreshableSectionedSlideExpandableListView extends
    ...
    public RefreshableSectionedSlideExpandableListView(Context context) {
        super(context);
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
            ...
            OverscrollHelper.overScrollBy(
                    RefreshableSectionedSlideExpandableListView.this, deltaY,
    ...
    protected class InternalListView extends
            PinnedSectionSlideexpandableListView implements
        ...
        public void setEmptyView(View emptyView) {
            RefreshableSectionedSlideExpandableListView.this
