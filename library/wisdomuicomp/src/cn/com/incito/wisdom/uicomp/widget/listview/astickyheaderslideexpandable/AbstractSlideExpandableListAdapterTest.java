 ...
 * @date 6/9/12 4:41 PM
 */
public abstract class AbstractSlideExpandableListAdapterTest extends
        WrapperListAdapterImplTest {
    /**
    ...
    public AbstractSlideExpandableListAdapterTest(ListAdapter wrapped) {
        super(wrapped);
    }

    public AbstractSlideExpandableListAdapterTest(Context context,
            ListAdapter wrapped, int sectionResourceId, int headerTextViewResId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.i("test", "AbstractSlideExpandableListAdapterTest  getView()");
        ...
        if (isSectionHeaderPosition(position)) {
            ...
            if (convertView != null && convertView.getTag() != null) {
                view = wrapped.getView(sectionedPositionToPosition(position),
                        convertView, parent);
            } else {
                view = wrapped.getView(sectionedPositionToPosition(position),
                        null, parent);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if (a != null && a.hasStarted() && !a.hasEnded()) {
                    ...
                    int type = target.getVisibility() == View.VISIBLE ? ExpandCollapseAnimationTest.COLLAPSE
                            : ExpandCollapseAnimationTest.EXPAND;

                    // remember the state
                    if (type == ExpandCollapseAnimationTest.EXPAND) {
                        ...
                        if (lastOpenPosition != -1
                            ...
                            if (lastOpen != null) {
                                animateView(lastOpen,
                                        ExpandCollapseAnimationTest.COLLAPSE);
                            }
    ...
    private void animateView(final View target, final int type) {
        Animation anim = new ExpandCollapseAnimationTest(target, type);
    ...
    public boolean collapseLastOpen() {
        if (isAnyItemExpanded()) {
            ...
            if (lastOpen != null) {
                animateView(lastOpen, ExpandCollapseAnimationTest.COLLAPSE);
            }
            openItems.set(lastOpenPosition, false);
            lastOpenPosition = -1;
            return true;
