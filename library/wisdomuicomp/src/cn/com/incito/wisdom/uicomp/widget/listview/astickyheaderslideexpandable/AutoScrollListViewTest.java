...
import cn.com.incito.wisdom.uicomp.widget.listview.astickyheaderslideexpandable.SlideExpandableListViewTest;
 ...
 */
public class AutoScrollListViewTest extends SlideExpandableListViewTest {
    ...
    public AutoScrollListViewTest(Context context) {
        super(context);
    }

    public AutoScrollListViewTest(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoScrollListViewTest(Context context, AttributeSet attrs, int defStyle) {
