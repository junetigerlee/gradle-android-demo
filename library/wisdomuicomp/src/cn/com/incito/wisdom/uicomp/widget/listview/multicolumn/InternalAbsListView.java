...
ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener {
	...
	public void reclaimViews(List<View> views) {
		...
		for (int i = 0; i < childCount; i++) {
			...
			InternalAbsListView.LayoutParams lp = (InternalAbsListView.LayoutParams) child.getLayoutParams();
	...
	class RecycleBin {
		...
		void addScrapView(View scrap) {
			InternalAbsListView.LayoutParams lp = (InternalAbsListView.LayoutParams) scrap.getLayoutParams();
			if (lp == null) {
				return;
			}
