...
package cn.com.incito.wisdom.uicomp.widget.listview.astickyheader.ui;
...
public class PinnedSectionGridView extends AutoScrollGridView {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view,
                PinnedSectionGridView.this);
        HeaderLayout header = (HeaderLayout) pinnedView
                .findViewById(getPinnedAdapter().getHeaderLayoutResId());
        ...
        if (BuildConfig.DEBUG && adapter != null) {
            if (!(adapter instanceof PinnedSectionGridAdapter))
                throw new IllegalArgumentException(
                        "Does your adapter implement PinnedSectionGridAdapter?");
    ...
    public static boolean isItemViewTypePinned(ListAdapter adapter, int position) {
        ...
        return ((PinnedSectionGridAdapter) adapter)
    ...
    private PinnedSectionGridAdapter getPinnedAdapter() {
        ...
        if (getAdapter() instanceof WrapperListAdapter)
            adapter = (PinnedSectionGridAdapter) ((WrapperListAdapter) getAdapter())
                    .getWrappedAdapter();
        else
            adapter = (PinnedSectionGridAdapter) getAdapter();
        return adapter;
    }
