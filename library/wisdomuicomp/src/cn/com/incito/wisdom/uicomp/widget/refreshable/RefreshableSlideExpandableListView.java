...
import cn.com.incito.wisdom.uicomp.widget.slideexpandable.SlideExpandableListView;

public class RefreshableSlideExpandableListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public RefreshableSlideExpandableListView(Context context) {
        super(context);
        setDisableScrollingWhileRefreshing(false);
    }

    public RefreshableSlideExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setDisableScrollingWhileRefreshing(false);
    }

    public RefreshableSlideExpandableListView(Context context, Mode mode) {
        super(context, mode);
        setDisableScrollingWhileRefreshing(false);
    }
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
            ...
            OverscrollHelper.overScrollBy(RefreshableSlideExpandableListView.this, deltaY,
    ...
    protected class InternalListView extends SlideExpandableListView implements
        ...
        public void setEmptyView(View emptyView) {
            RefreshableSlideExpandableListView.this.setEmptyView(emptyView);
        }
