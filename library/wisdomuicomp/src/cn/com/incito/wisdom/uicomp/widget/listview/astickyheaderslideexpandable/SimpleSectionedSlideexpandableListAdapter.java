...
public class SimpleSectionedSlideexpandableListAdapter extends
        SlideExpandableListAdapter implements PinnedSectionListAdapter {
    ...
    public SimpleSectionedSlideexpandableListAdapter(Context context,
            BaseAdapter baseAdapter, int sectionResourceId,
            int headerTextViewResId, int toggle_button_id,
            int expandable_view_id) {
        super(baseAdapter, toggle_button_id, expandable_view_id);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (isSectionHeaderPosition(position)) {
            ...
            return super.getView(sectionedPositionToPosition(position),
                    convertView, parent);
            // return
            // mBaseAdapter.getView(sectionedPositionToPosition(position),
            // convertView, parent);
        }
    }
