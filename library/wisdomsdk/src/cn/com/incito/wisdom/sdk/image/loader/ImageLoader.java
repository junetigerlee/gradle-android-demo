...
import cn.com.incito.wisdom.sdk.image.loader.assist.SimpleImageLoadingListener;
...
public class ImageLoader {
	...
	private final BitmapDisplayer defaultBitmapDisplayer = new BitmapDisplayerImpl(DisplayShape.DEFAULT, DisplayAnim.NONE);
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener) {
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				...
				options.getDisplayer().display(bmp, imageView, false, LoadedFrom.MEMORY_CACHE);
	...
	public void loadImage(String uri, ImageSize targetImageSize, DisplayImageOptions options, ImageLoadingListener listener) {
		...
		DisplayImageOptions optionsWithDefaultDisplayer;
		if (options.getDisplayer() instanceof BitmapDisplayerImpl) {
			optionsWithDefaultDisplayer = options;
		} else {
			optionsWithDefaultDisplayer = new DisplayImageOptions.Builder().cloneFrom(options).displayer(defaultBitmapDisplayer).build();
		}

		ImageView defalutImage = new ImageView(configuration.context);
		defalutImage.setLayoutParams(new LayoutParams(targetImageSize.getWidth(), targetImageSize.getHeight()));
		defalutImage.setScaleType(ScaleType.CENTER_CROP);

		displayImage(uri, defalutImage, optionsWithDefaultDisplayer, listener);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public AbstractMemoryCache<String, Bitmap> getMemoryCache() {
		checkConfiguration();
