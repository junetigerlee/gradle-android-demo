...
import cn.com.incito.wisdom.sdk.cache.mem.model.FuzzyKeyMemoryCache;
...
import cn.com.incito.wisdom.sdk.net.download.NetworkDeniedImageDownloader;
...
public final class ImageLoaderConfiguration {
	...
	final AbstractMemoryCache<String, Bitmap> memoryCache;
	final AbstractDiscCache discCache;
	final ImageDownloader downloader;
	final ImageDecoder decoder;
	final DisplayImageOptions defaultDisplayImageOptions;
	final boolean loggingEnabled;

	final AbstractDiscCache reserveDiscCache;
	...
	public static class Builder {
		...
		private AbstractMemoryCache<String, Bitmap> memoryCache = null;
		private AbstractDiscCache discCache = null;
		 ...
		 * {@link cn.com.incito.wisdom.sdk.image.loader.assist.UsingFreqLimitedMemoryBitmapCache UsingFreqLimitedCache}
		 ...
		 * Default value - {@link cn.com.incito.wisdom.sdk.image.loader.assist.UsingFreqLimitedMemoryBitmapCache
		 * UsingFreqLimitedCache} with limited memory cache size (size = 1/8 of available app memory)<br />
		 * <br />
		 ...
		 * </ul>
		 */
		public Builder memoryCache(AbstractMemoryCache<String, Bitmap> memoryCache) {
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link cn.com.incito.wisdom.sdk.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(AbstractDiscCache)} method for introduction your own
		 * implementation of {@link AbstractDiscCache}
		 */
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link cn.com.incito.wisdom.sdk.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(AbstractDiscCache)} method for introduction your own
		 * implementation of {@link AbstractDiscCache}
		 */
		 ...
		 * Default value -
		 * {@link cn.com.incito.wisdom.sdk.image.loader.DefaultConfigurationFactory#createFileNameGenerator()
		...
		* */
		 ...
		 * Default value - {@link cn.com.incito.wisdom.sdk.cache.disk.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by <b>
		 * {@link cn.com.incito.wisdom.sdk.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * </ul>
		 */
		public Builder discCache(AbstractDiscCache discCache) {
		...
		private void initEmptyFiledsWithDefaultValues() {
			...
			if (discCache == null) {
				if (discCacheFileNameGenerator == null) {
					discCacheFileNameGenerator = DiskCacheConfigFactory.createFileNameGenerator();
				}
