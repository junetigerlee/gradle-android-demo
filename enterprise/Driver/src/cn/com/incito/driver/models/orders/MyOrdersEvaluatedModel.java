...
import cn.com.incito.driver.net.apis.orders.MyEvaluatedOrdersAPI;
 ...
 * @version 1.0
 */
public class MyOrdersEvaluatedModel extends
        ListAbstractModel<OrdersEvaluated, MyEvaluatedOrdersAPI, MyEvaluatedOrdersAPI.MyEvaluatedOrdersAPIResponse> {
    // /logistics/goods/myCollectionGoods
    public static final String sDefaultUrl = "myOrdersEvaluated";
    ...
    public MyOrdersEvaluatedModel(Context context, SQLiteDatabase db, AbstractDaoMaster daoMaster) {
        super(context, db, daoMaster);
    }

    @Override
    protected Class<OrdersEvaluated> getDAOModelClassName() {
        return OrdersEvaluated.class;
    }

    @Override
    protected MyEvaluatedOrdersAPI newAPIInstance(Map<String, Object> params) {
        return new MyEvaluatedOrdersAPI(params);
    }

    @Override
    protected List<OrdersEvaluated> getAPIResponse(MyEvaluatedOrdersAPI.MyEvaluatedOrdersAPIResponse r) {
        return r.mList;
    }
