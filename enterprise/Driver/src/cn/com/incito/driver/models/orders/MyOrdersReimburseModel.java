...
import cn.com.incito.driver.net.apis.orders.MyReimburseOrdersAPI;
 ...
 * @version 1.0
 */
public class MyOrdersReimburseModel extends
        ListAbstractModel<OrdersReimburse, MyReimburseOrdersAPI, MyReimburseOrdersAPI.MyReimburseOrdersAPIResponse> {
    // /logistics/goods/myCollectionGoods
    public static final String sDefaultUrl = "myOrdersReimburse";
    ...
    public MyOrdersReimburseModel(Context context, SQLiteDatabase db, AbstractDaoMaster daoMaster) {
        super(context, db, daoMaster);
    }

    @Override
    protected Class<OrdersReimburse> getDAOModelClassName() {
        return OrdersReimburse.class;
    }

    @Override
    protected MyReimburseOrdersAPI newAPIInstance(Map<String, Object> params) {
        return new MyReimburseOrdersAPI(params);
    }

    @Override
    protected List<OrdersReimburse> getAPIResponse(MyReimburseOrdersAPI.MyReimburseOrdersAPIResponse r) {
        return r.mList;
    }
