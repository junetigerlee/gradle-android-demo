...
import cn.com.incito.driver.net.apis.orders.MySignOrdersAPI;
 ...
 * @version 1.0
 */
public class MyOrdersSignModel extends
        ListAbstractModel<OrdersSign, MySignOrdersAPI, MySignOrdersAPI.MySignOrdersAPIResponse> {
    public static final String sDefaultUrl = "myOrdersSign";
    ...
    public MyOrdersSignModel(Context context, SQLiteDatabase db, AbstractDaoMaster daoMaster) {
        super(context, db, daoMaster);
    }

    @Override
    protected Class<OrdersSign> getDAOModelClassName() {
        return OrdersSign.class;
    }

    @Override
    protected MySignOrdersAPI newAPIInstance(Map<String, Object> params) {
        return new MySignOrdersAPI(params);
    }

    @Override
    protected List<OrdersSign> getAPIResponse(MySignOrdersAPI.MySignOrdersAPIResponse r) {
        return r.mList;
    }
