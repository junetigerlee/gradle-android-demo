...
import cn.com.incito.driver.net.apis.orders.MyObligationOrdersAPI;
 ...
 * @version 1.0
 */
public class MyOrdersObligationModel extends
        ListAbstractModel<OrdersObligation, MyObligationOrdersAPI, MyObligationOrdersAPI.MyObligationOrdersAPIResponse> {
    // /logistics/goods/myCollectionGoods
    public static final String sDefaultUrl = "myOrdersObligation";
    ...
    public MyOrdersObligationModel(Context context, SQLiteDatabase db, AbstractDaoMaster daoMaster) {
        super(context, db, daoMaster);
    }

    @Override
    protected Class<OrdersObligation> getDAOModelClassName() {
        return OrdersObligation.class;
    }

    @Override
    protected MyObligationOrdersAPI newAPIInstance(Map<String, Object> params) {
        return new MyObligationOrdersAPI(params);
    }

    @Override
    protected List<OrdersObligation> getAPIResponse(MyObligationOrdersAPI.MyObligationOrdersAPIResponse r) {
        return r.mList;
    }
