...
import cn.com.incito.driver.net.apis.goods.GoodsHasAvailableAPI;
import cn.com.incito.driver.net.apis.goods.GoodsHasAvailableAPI.GoodsHasAvailableAPIResponse;
 ...
 * @version 1.0
 */
public class GoodsHasAvailableModel extends
        ListAbstractModel<GoodsHasAvailable, GoodsHasAvailableAPI, GoodsHasAvailableAPI.GoodsHasAvailableAPIResponse> {
    public static final String sDefaultUrl = "goodsHasAvailable";
    ...
    public static final String SEARCH_VCOLUMN_STATUS = "status";// 0全部，1成功 2失败
                                                                // 3审核中
    ...
    public GoodsHasAvailableModel(Context context, SQLiteDatabase db, AbstractDaoMaster daoMaster) {
        super(context, db, daoMaster);
    }

    @Override
    protected Class<GoodsHasAvailable> getDAOModelClassName() {
        return GoodsHasAvailable.class;
    }

    @Override
    protected GoodsHasAvailableAPI newAPIInstance(Map<String, Object> params) {
        return new GoodsHasAvailableAPI(params);
    }

    @Override
    protected List<GoodsHasAvailable> getAPIResponse(GoodsHasAvailableAPIResponse r) {
        return r.mList;
    }
