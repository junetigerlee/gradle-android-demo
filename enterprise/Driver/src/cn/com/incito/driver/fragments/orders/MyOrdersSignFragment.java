 ...
 * 我的订单-待签收
 * 
 * @description 我的订单-待签收
 * @author qiujiaheng
 * @createDate 2014年10月14日
 * @version 1.0
 */
public class MyOrdersSignFragment extends AbstractMyOrderFragment<ListView, MyOrdersSignModel.Response> {
    ...
    protected void loadData(boolean update, boolean loadmore) {
        ...
        if (update) {
            ...
            String[] selectionArgs = new String[] {
                    ...
                    Integer.toString(mPageSize), String.valueOf(Constants.MYORDER_TYPE_SIGN),
                    String.valueOf(fragment.mTimeRange)
            };
            query(update, loadmore, DataProvider.getUri(MyOrdersSignModel.class, loadmore), null, selection.toString(),
                    selectionArgs, null);
        } else {
            ...
            sortOrder.append(offset);
            query(update, loadmore, DataProvider.getUri(MyOrdersSignModel.class, loadmore), PROJECTIONS, null, null,
                    sortOrder.toString());
        }

    }

    public void onEvent(final MyOrdersSignModel.Response resp) {
