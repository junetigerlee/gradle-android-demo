 ...
 * @version 1.0
 */
public class MyOrdersAllFragment extends AbstractMyOrderFragment<ListView, MyOrdersAllModel.Response> {
    ...
    protected void loadData(boolean update, boolean loadmore) {
        ...
        if (update) {
            ...
            String[] selectionArgs = new String[] {
                    ...
                    Integer.toString(mPageSize), String.valueOf(Constants.MYORDER_TYPE_ALL),
                    String.valueOf(fragment.mTimeRange)
            };
            query(update, loadmore, DataProvider.getUri(MyOrdersAllModel.class, loadmore), null, selection.toString(),
                    selectionArgs, null);
        } else {
            ...
            sortOrder.append(offset);
            query(update, loadmore, DataProvider.getUri(MyOrdersAllModel.class, loadmore), PROJECTIONS, null, null,
                    sortOrder.toString());
        }

    }

    public void onEvent(final MyOrdersAllModel.Response resp) {
