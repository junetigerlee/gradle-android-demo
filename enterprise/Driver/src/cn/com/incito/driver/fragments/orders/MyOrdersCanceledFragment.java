 ...
 * 我的订单-已取消
 * 
 * @description 我的订单-已取消
 * @author qiujiaheng
 * @createDate 2014年10月14日
 * @version 1.0
 */
public class MyOrdersCanceledFragment extends AbstractMyOrderFragment<ListView, MyOrdersCanceledModel.Response> {
    ...
    protected void loadData(boolean update, boolean loadmore) {
        ...
        if (update) {
            ...
            String[] selectionArgs = new String[] {
                    ...
                    Integer.toString(mPageSize), String.valueOf(Constants.MYORDER_TYPE_CANCELED),
                    String.valueOf(fragment.mTimeRange)
            };
            query(update, loadmore, DataProvider.getUri(MyOrdersCanceledModel.class, loadmore), null,
            ...
            sortOrder.append(offset);
            query(update, loadmore, DataProvider.getUri(MyOrdersCanceledModel.class, loadmore), PROJECTIONS, null,
                    null, sortOrder.toString());
        }

    }

    public void onEvent(final MyOrdersCanceledModel.Response resp) {
