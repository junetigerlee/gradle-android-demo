 ...
 * 我的订单-待配货
 * 
 * @description 我的订单-待配货
 * @author qiujiaheng
 * @createDate 2014年10月14日
 * @version 1.0
 */
public class MyOrdersDistributionFragment extends AbstractMyOrderFragment<ListView, MyOrdersDistributionModel.Response> {
    ...
    protected void loadData(boolean update, boolean loadmore) {
        ...
        if (update) {
            ...
            String[] selectionArgs = new String[] {
                    ...
                    Integer.toString(mPageSize), String.valueOf(Constants.MYORDER_TYPE_DISTRIBUTION),
                    String.valueOf(fragment.mTimeRange)
            };
            query(update, loadmore, DataProvider.getUri(MyOrdersDistributionModel.class, loadmore), null,
            ...
            sortOrder.append(offset);
            query(update, loadmore, DataProvider.getUri(MyOrdersDistributionModel.class, loadmore), PROJECTIONS, null,
                    null, sortOrder.toString());
        }

    }

    public void onEvent(final MyOrdersDistributionModel.Response resp) {
