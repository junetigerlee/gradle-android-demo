 ...
 * 我的订单-待评价
 * 
 * @description 我的订单-待评价
 * @author qiujiaheng
 * @createDate 2014年10月14日
 * @version 1.0
 */
public class MyOrdersEvaluatedFragment extends AbstractMyOrderFragment<ListView, MyOrdersEvaluatedModel.Response> {
    ...
    protected void loadData(boolean update, boolean loadmore) {
        ...
        if (update) {
            ...
            String[] selectionArgs = new String[] {
                    ...
                    Integer.toString(mPageSize), String.valueOf(Constants.MYORDER_TYPE_EVALUATE),
                    String.valueOf(fragment.mTimeRange)
            };
            query(update, loadmore, DataProvider.getUri(MyOrdersEvaluatedModel.class, loadmore), null,
            ...
            sortOrder.append(offset);
            query(update, loadmore, DataProvider.getUri(MyOrdersEvaluatedModel.class, loadmore), PROJECTIONS, null,
                    null, sortOrder.toString());
        }

    }

    public void onEvent(final MyOrdersEvaluatedModel.Response resp) {
