...
/** 
 * DAO for table ORDERS_CANCELED.
*/
public class OrdersCanceledDao extends AbstractDao<OrdersCanceled, Long> {

    public static final String TABLENAME = "ORDERS_CANCELED";

    /**
     * Properties of entity OrdersCanceled.<br/>
    ...
    */
    ...
    public OrdersCanceledDao(DaoConfig config) {
        super(config);
    }
    
    public OrdersCanceledDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDERS_CANCELED' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDERS_CANCELED'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrdersCanceled entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OrdersCanceled readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrdersCanceled entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrdersCanceled entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrdersCanceled entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
