...
/** 
 * DAO for table ORDERS_OBLIGATION.
*/
public class OrdersObligationDao extends AbstractDao<OrdersObligation, Long> {

    public static final String TABLENAME = "ORDERS_OBLIGATION";

    /**
     * Properties of entity OrdersObligation.<br/>
    ...
    */
    ...
    public OrdersObligationDao(DaoConfig config) {
        super(config);
    }
    
    public OrdersObligationDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDERS_OBLIGATION' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDERS_OBLIGATION'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrdersObligation entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OrdersObligation readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrdersObligation entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrdersObligation entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrdersObligation entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
