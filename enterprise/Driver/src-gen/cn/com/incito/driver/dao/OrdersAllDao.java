...
/** 
 * DAO for table ORDERS_ALL.
*/
public class OrdersAllDao extends AbstractDao<OrdersAll, Long> {

    public static final String TABLENAME = "ORDERS_ALL";

    /**
     * Properties of entity OrdersAll.<br/>
    ...
    */
    ...
    public OrdersAllDao(DaoConfig config) {
        super(config);
    }
    
    public OrdersAllDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDERS_ALL' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDERS_ALL'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrdersAll entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OrdersAll readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrdersAll entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrdersAll entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrdersAll entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
