...
/** 
 * DAO for table ORDERS_RECEIVED.
*/
public class OrdersReceivedDao extends AbstractDao<OrdersReceived, Long> {

    public static final String TABLENAME = "ORDERS_RECEIVED";

    /**
     * Properties of entity OrdersReceived.<br/>
    ...
    */
    ...
    public OrdersReceivedDao(DaoConfig config) {
        super(config);
    }
    
    public OrdersReceivedDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDERS_RECEIVED' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDERS_RECEIVED'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrdersReceived entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OrdersReceived readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrdersReceived entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrdersReceived entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrdersReceived entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
