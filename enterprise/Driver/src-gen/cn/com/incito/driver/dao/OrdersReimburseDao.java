...
/** 
 * DAO for table ORDERS_REIMBURSE.
*/
public class OrdersReimburseDao extends AbstractDao<OrdersReimburse, Long> {

    public static final String TABLENAME = "ORDERS_REIMBURSE";

    /**
     * Properties of entity OrdersReimburse.<br/>
    ...
    */
    ...
    public OrdersReimburseDao(DaoConfig config) {
        super(config);
    }
    
    public OrdersReimburseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDERS_REIMBURSE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDERS_REIMBURSE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrdersReimburse entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OrdersReimburse readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrdersReimburse entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrdersReimburse entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrdersReimburse entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
