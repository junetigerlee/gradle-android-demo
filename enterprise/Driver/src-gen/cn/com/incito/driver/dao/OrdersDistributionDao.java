...
/** 
 * DAO for table ORDERS_DISTRIBUTION.
*/
public class OrdersDistributionDao extends AbstractDao<OrdersDistribution, Long> {

    public static final String TABLENAME = "ORDERS_DISTRIBUTION";

    /**
     * Properties of entity OrdersDistribution.<br/>
    ...
    */
    ...
    public OrdersDistributionDao(DaoConfig config) {
        super(config);
    }
    
    public OrdersDistributionDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDERS_DISTRIBUTION' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDERS_DISTRIBUTION'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrdersDistribution entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OrdersDistribution readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrdersDistribution entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrdersDistribution entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrdersDistribution entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
